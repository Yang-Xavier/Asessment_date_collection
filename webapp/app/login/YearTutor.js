...
class YearTutor extends BaseNode {
    ...
    constructor() {
        ...
        this.navbar_brand = $('<a class="navbar-brand" href="#">Year Tutor</a>');
        this.logo = $('<span class="logo"></span>');
        ...
        this.side_bar =$('<div class="sidebar-sticky">\n' +
            ...
            '              Assessment form <span class="sr-only">(current)</span>\n' +
            '            </a>\n' +
            '          </li>\n' +
            '          <li class="nav-item">\n' +
