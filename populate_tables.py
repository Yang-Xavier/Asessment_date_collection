...
Assessment(format="mole_quiz", name="Breadth of Knowledge Test (Part 2)", marks=5, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("29/03/19","%d/%m/%y"),  form=forms[0])
Assessment(format="mole_quiz", name="Breadth of Knowledge Test (Part 1)", marks=5, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("13/11/18","%d/%m/%y"),  form=forms[0])
...
Assessment(format="group_project", name="Individual performance", marks=30, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("17/05/19","%d/%m/%y"),  form=forms[2])
...
Assessment(format="mole_quiz", name="Breadth of Knowledge Test (Part 2)", marks=5, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("26/03/19","%d/%m/%y"),  form=forms[3])
Assessment(format="mole_quiz", name="Breadth of Knowledge Test (Part 1)", marks=5, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("12/11/18","%d/%m/%y"),  form=forms[3])
...
Assessment(format="mole_quiz", name="Mole Quiz", marks=35, release_date=datetime.strptime("12/11/18","%d/%m/%y"), submission_date=datetime.strptime("12/11/18","%d/%m/%y"),  form=forms[4])
...
Assessment(format="mole_quiz", name="Quiz 4", marks=25, release_date=datetime.strptime("23/11/18","%d/%m/%y"), submission_date=datetime.strptime("07/12/18","%d/%m/%y"),  form=forms[5])
Assessment(format="mole_quiz", name="Quiz 3", marks=25, release_date=datetime.strptime("23/11/18","%d/%m/%y"), submission_date=datetime.strptime("23/11/18","%d/%m/%y"),  form=forms[5])
Assessment(format="mole_quiz", name="Quiz 2", marks=25, release_date=datetime.strptime("02/11/18","%d/%m/%y"), submission_date=datetime.strptime("02/11/18","%d/%m/%y"),  form=forms[5])
Assessment(format="mole_quiz", name="Quiz 1", marks=25, release_date=datetime.strptime("19/10/18","%d/%m/%y"), submission_date=datetime.strptime("19/10/18","%d/%m/%y"),  form=forms[5])
Assessment(format="mole_quiz", name="Mole Quiz 2", marks=15, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("07/12/18","%d/%m/%y"),  form=forms[6])
Assessment(format="mole_quiz", name="Mole Quiz 1", marks=10, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("26/10/18","%d/%m/%y"),  form=forms[6])
...
Assessment(format="mole_quiz", name="Final MCQ Exam", marks=60, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("10/12/18","%d/%m/%y"),  form=forms[7])
Assessment(format="assessed_lab", name="Assessed Lab", marks=40, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("03/12/18","%d/%m/%y"),  form=forms[7])
Assessment(format="formal_exam", name="Exam", marks=50, release_date=datetime.strptime("31/01/19","%d/%m/%y"), submission_date=datetime.strptime("31/01/19","%d/%m/%y"),  form=forms[8])
...
Assessment(format="mole_quiz", name="MOLE Formal Examination", marks=50, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("01/02/19","%d/%m/%y"),  form=forms[9])
Assessment(format="group_project", name="Individual Testing Report", marks=10, release_date=datetime.strptime("03/12/18","%d/%m/%y"), submission_date=datetime.strptime("07/12/18","%d/%m/%y"),  form=forms[9])
Assessment(format="group_project", name="Group Systems Design Project", marks=40, release_date=datetime.strptime("15/10/18","%d/%m/%y"), submission_date=datetime.strptime("02/12/18","%d/%m/%y"),  form=forms[9])
...
Assessment(format="formal_exam", name="Exam", marks=40, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("01/02/19","%d/%m/%y"),  form=forms[11])
...
Assessment(format="mole_quiz", name="MOLE Quiz 2", marks=25, release_date=datetime.strptime("14/11/18","%d/%m/%y"), submission_date=datetime.strptime("05/12/18","%d/%m/%y"),  form=forms[12])
Assessment(format="mole_quiz", name="MOLE Quiz 1", marks=20, release_date=datetime.strptime("14/11/18","%d/%m/%y"), submission_date=datetime.strptime("14/11/18","%d/%m/%y"),  form=forms[12])
...
Assessment(format="assessed_lab", name="Introductory Programming Exercise", marks=10, release_date=datetime.strptime("01/10/18","%d/%m/%y"), submission_date=datetime.strptime("22/10/18","%d/%m/%y"),  form=forms[12])
Assessment(format="formal_exam", name="Exam", marks=60, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("01/02/19","%d/%m/%y"),  form=forms[13])
...
Assessment(format="mole_quiz", name="MOLE quiz", marks=40, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("10/12/18","%d/%m/%y"),  form=forms[14])
Assessment(format="assessed_lab", name="Lab assessment 2", marks=30, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("14/12/18","%d/%m/%y"),  form=forms[14])
Assessment(format="assessed_lab", name="Lab assessment 1", marks=30, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("02/11/18","%d/%m/%y"),  form=forms[14])
Assessment(format="formal_exam", name="Examination", marks=50, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("01/02/19","%d/%m/%y"),  form=forms[15])
...
Assessment(format="mole_quiz", name="MOLE Quiz 2", marks=25, release_date=datetime.strptime("14/11/18","%d/%m/%y"), submission_date=datetime.strptime("05/12/18","%d/%m/%y"),  form=forms[16])
Assessment(format="mole_quiz", name="MOLE Quiz 1", marks=20, release_date=datetime.strptime("14/11/18","%d/%m/%y"), submission_date=datetime.strptime("14/11/18","%d/%m/%y"),  form=forms[16])
...
Assessment(format="assessed_lab", name="Introductory Programming Exercise", marks=10, release_date=datetime.strptime("01/10/18","%d/%m/%y"), submission_date=datetime.strptime("22/10/18","%d/%m/%y"),  form=forms[16])
Assessment(format="formal_exam", name="Exam", marks=40, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("01/02/19","%d/%m/%y"),  form=forms[17])
...
Assessment(format="mole_quiz", name="MOLE quiz 2", marks=20, release_date=datetime.strptime("20/11/18","%d/%m/%y"), submission_date=datetime.strptime("20/11/18","%d/%m/%y"),  form=forms[18])
Assessment(format="mole_quiz", name="Mole Quiz 1", marks=20, release_date=datetime.strptime("23/10/18","%d/%m/%y"), submission_date=datetime.strptime("23/10/18","%d/%m/%y"),  form=forms[18])
...
Assessment(format="mole_quiz", name="MCQ", marks=15, release_date=datetime.strptime("05/12/18","%d/%m/%y"), submission_date=datetime.strptime("05/12/18","%d/%m/%y"),  form=forms[19])
Assessment(format="formal_exam", name="Final Exam", marks=50, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("01/02/19","%d/%m/%y"),  form=forms[19])
...
Assessment(format="formal_exam", name="Podcast Creation: Fundamental Security Properties and Mechanisms", marks=10, release_date=datetime.strptime("10/12/18","%d/%m/%y"), submission_date=datetime.strptime("25/01/19","%d/%m/%y"),  form=forms[21])
Assessment(format="formal_exam", name="Formal Examination 1: Fundmental Security Properties and Mechanisms", marks=90, release_date=datetime.strptime("01/02/19","%d/%m/%y"), submission_date=datetime.strptime("01/02/18","%d/%m/%y"),  form=forms[21])
...
Assessment(format="assessed_lab", name="Forensics Lab", marks=50, release_date=datetime.strptime("21/01/19","%d/%m/%y"), submission_date=datetime.strptime("21/01/18","%d/%m/%y"),  form=forms[22])
Assessment(format="formal_exam", name="formal examination", marks=80, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("01/02/19","%d/%m/%y"),  form=forms[23])
...
Assessment(format="assessed_lab", name="Assessed Lab 2", marks=20, release_date=datetime.strptime("10/12/18","%d/%m/%y"), submission_date=datetime.strptime("10/12/18","%d/%m/%y"),  form=forms[26])
Assessment(format="assessed_lab", name="Assessed Lab 1", marks=20, release_date=datetime.strptime("29/10/18","%d/%m/%y"), submission_date=datetime.strptime("29/10/18","%d/%m/%y"),  form=forms[26])
...
Assessment(format="mole_quiz", name="Breadth of Knowledge Test", marks=10, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("13/11/18","%d/%m/%y"),  form=forms[27])
...
Assessment(format="mole_quiz", name="Final MCQ Exam", marks=60, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("10/12/18","%d/%m/%y"),  form=forms[29])
Assessment(format="assessed_lab", name="Assessed Lab", marks=40, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("03/12/18","%d/%m/%y"),  form=forms[29])
Assessment(format="formal_exam", name="Exam", marks=100, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("01/01/18","%d/%m/%y"),  form=forms[30])
Assessment(format="mole_quiz", name="MOLE Quiz 5", marks=2.5, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("10/05/19","%d/%m/%y"),  form=forms[31])
Assessment(format="mole_quiz", name="MOLE Quiz 4", marks=2.5, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("29/03/19","%d/%m/%y"),  form=forms[31])
Assessment(format="mole_quiz", name="MOLE Quiz 3", marks=2.5, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("15/03/19","%d/%m/%y"),  form=forms[31])
Assessment(format="mole_quiz", name="MOLE Quiz 2", marks=2.5, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("01/03/19","%d/%m/%y"),  form=forms[31])
Assessment(format="mole_quiz", name="MOLE Quiz 1", marks=2.5, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("15/02/19","%d/%m/%y"),  form=forms[31])
Assessment(format="problem_sheet", name="Lab Problem Sheet 2", marks=30, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("15/03/19","%d/%m/%y"),  form=forms[31])
Assessment(format="problem_sheet", name="Lab Problem Sheet 1", marks=30, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("01/03/19","%d/%m/%y"),  form=forms[31])
...
Assessment(format="group_project", name="Semester 2 Exam", marks=25, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("01/06/18","%d/%m/%y"),  form=forms[32])
...
Assessment(format="formal_exam", name="Exam", marks=20, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("01/06/18","%d/%m/%y"),  form=forms[33])
Assessment(format="problem_sheet", name="Third marked problem sheet", marks=20, release_date=datetime.strptime("18/03/18","%d/%m/%y"), submission_date=datetime.strptime("25/03/18","%d/%m/%y"),  form=forms[33])
Assessment(format="problem_sheet", name="Second marked problem sheet", marks=20, release_date=datetime.strptime("04/03/18","%d/%m/%y"), submission_date=datetime.strptime("11/03/18","%d/%m/%y"),  form=forms[33])
Assessment(format="problem_sheet", name="Fourth marked problem sheet", marks=20, release_date=datetime.strptime("18/03/18","%d/%m/%y"), submission_date=datetime.strptime("29/04/18","%d/%m/%y"),  form=forms[33])
Assessment(format="problem_sheet", name="First marked problem sheet", marks=20, release_date=datetime.strptime("18/02/18","%d/%m/%y"), submission_date=datetime.strptime("25/02/18","%d/%m/%y"),  form=forms[33])
Assessment(format="formal_exam", name="exam", marks=100, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("06/01/18","%d/%m/%y"),  form=forms[34])
Assessment(format="formal_exam", name="n/a", marks=100, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("01/06/19","%d/%m/%y"),  form=forms[35])
Assessment(format="formal_exam", name="Exam", marks=70, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("01/06/19","%d/%m/%y"),  form=forms[36])
...
Assessment(format="mole_quiz", name="MOLE Quiz 4", marks=9, release_date=datetime.strptime("19/03/19","%d/%m/%y"), submission_date=datetime.strptime("03/05/19","%d/%m/%y"),  form=forms[38])
Assessment(format="mole_quiz", name="MOLE Quiz 3", marks=9, release_date=datetime.strptime("19/03/19","%d/%m/%y"), submission_date=datetime.strptime("24/03/19","%d/%m/%y"),  form=forms[38])
Assessment(format="mole_quiz", name="MOLE Quiz 2", marks=9, release_date=datetime.strptime("04/03/19","%d/%m/%y"), submission_date=datetime.strptime("09/03/19","%d/%m/%y"),  form=forms[38])
Assessment(format="mole_quiz", name="Mole Quiz 1", marks=3, release_date=datetime.strptime("11/02/19","%d/%m/%y"), submission_date=datetime.strptime("15/02/19","%d/%m/%y"),  form=forms[38])
Assessment(format="formal_exam", name="Exam", marks=70, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("06/01/19","%d/%m/%y"),  form=forms[38])
Assessment(format="mole_quiz", name="MOLE Quiz 4", marks=9, release_date=datetime.strptime("18/03/18","%d/%m/%y"), submission_date=datetime.strptime("02/05/18","%d/%m/%y"),  form=forms[39])
Assessment(format="mole_quiz", name="MOLE Quiz 3", marks=9, release_date=datetime.strptime("18/03/18","%d/%m/%y"), submission_date=datetime.strptime("23/03/18","%d/%m/%y"),  form=forms[39])
Assessment(format="mole_quiz", name="MOLE Quiz 2", marks=9, release_date=datetime.strptime("04/03/18","%d/%m/%y"), submission_date=datetime.strptime("09/03/18","%d/%m/%y"),  form=forms[39])
Assessment(format="mole_quiz", name="MOLE Quiz 1", marks=3, release_date=datetime.strptime("02/11/18","%d/%m/%y"), submission_date=datetime.strptime("02/12/18","%d/%m/%y"),  form=forms[39])
Assessment(format="formal_exam", name="Exam", marks=70, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("01/06/18","%d/%m/%y"),  form=forms[39])
Assessment(format="formal_exam", name="exam", marks=100, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("06/01/18","%d/%m/%y"),  form=forms[40])
Assessment(format="mole_quiz", name="MCQ 9", marks=2, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("03/04/19","%d/%m/%y"),  form=forms[41])
Assessment(format="mole_quiz", name="MCQ 8", marks=2, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("27/03/19","%d/%m/%y"),  form=forms[41])
Assessment(format="mole_quiz", name="MCQ 7", marks=2, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("20/03/19","%d/%m/%y"),  form=forms[41])
Assessment(format="mole_quiz", name="MCQ 6", marks=2, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("13/03/19","%d/%m/%y"),  form=forms[41])
Assessment(format="mole_quiz", name="MCQ 5", marks=2, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("06/03/19","%d/%m/%y"),  form=forms[41])
Assessment(format="mole_quiz", name="MCQ 4", marks=20, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("27/02/19","%d/%m/%y"),  form=forms[41])
Assessment(format="mole_quiz", name="MCQ 3", marks=20, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("20/02/19","%d/%m/%y"),  form=forms[41])
Assessment(format="mole_quiz", name="MCQ 2", marks=20, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("13/02/19","%d/%m/%y"),  form=forms[41])
Assessment(format="mole_quiz", name="MCQ 1", marks=30, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("06/02/19","%d/%m/%y"),  form=forms[41])
...
Assessment(format="mole_quiz", name="MOLE Quizz 2", marks=10, release_date=datetime.strptime("18/03/18","%d/%m/%y"), submission_date=datetime.strptime("23/03/18","%d/%m/%y"),  form=forms[43])
Assessment(format="mole_quiz", name="MOLE Quiz 3", marks=10, release_date=datetime.strptime("29/04/18","%d/%m/%y"), submission_date=datetime.strptime("03/05/18","%d/%m/%y"),  form=forms[43])
Assessment(format="mole_quiz", name="MOLE Quiz 1", marks=10, release_date=datetime.strptime("04/03/18","%d/%m/%y"), submission_date=datetime.strptime("09/03/18","%d/%m/%y"),  form=forms[43])
Assessment(format="formal_exam", name="Exam", marks=70, release_date=datetime.strptime("29/04/18","%d/%m/%y"), submission_date=datetime.strptime("01/06/18","%d/%m/%y"),  form=forms[43])
...
Assessment(format="mole_quiz", name="Breadth of Knowledge Test", marks=10, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("27/03/19","%d/%m/%y"),  form=forms[47])
...
Assessment(format="formal_exam", name="Exam", marks=60, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("01/06/19","%d/%m/%y"),  form=forms[50])
...
Assessment(format="formal_exam", name="Exam", marks=35, release_date=datetime.strptime("10/06/18","%d/%m/%y"), submission_date=datetime.strptime("01/06/19","%d/%m/%y"),  form=forms[51])
