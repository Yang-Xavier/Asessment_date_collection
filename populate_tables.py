...
# assessments.
Assessment(format=AssessmentFormat.PRESENTATION, name="Time sheets", marks=0.05, release_date=datetime.strptime("10/06/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("20/05/19 23:59","%d/%m/%y %H:%M"),  module=modules[37])
...
Assessment(format=AssessmentFormat.PRESENTATION, name="Initial PRESENTATION", marks=0.05, release_date=datetime.strptime("16/10/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("06/11/18 23:59","%d/%m/%y %H:%M"),  module=modules[2])
...
Assessment(format=AssessmentFormat.PORTFOLIO, name="PORTFOLIO", marks=1, release_date=datetime.strptime("24/09/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("10/12/18 23:59","%d/%m/%y %H:%M"),  module=modules[24])
Assessment(format=AssessmentFormat.MOLE_QUIZ, name="Quiz 4", marks=3.75, release_date=datetime.strptime("23/11/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("07/12/18 23:59","%d/%m/%y %H:%M"),  module=modules[5])
Assessment(format=AssessmentFormat.MOLE_QUIZ, name="Quiz 3", marks=3.75, release_date=datetime.strptime("23/11/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("23/11/18 23:59","%d/%m/%y %H:%M"),  module=modules[5])
Assessment(format=AssessmentFormat.MOLE_QUIZ, name="Quiz 2", marks=3.75, release_date=datetime.strptime("02/11/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("02/11/18 23:59","%d/%m/%y %H:%M"),  module=modules[5])
Assessment(format=AssessmentFormat.MOLE_QUIZ, name="Quiz 1", marks=3.75, release_date=datetime.strptime("19/10/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("19/10/18 23:59","%d/%m/%y %H:%M"),  module=modules[5])
...
Assessment(format=AssessmentFormat.MOLE_QUIZ, name="Mole Quiz", marks=43617, release_date=datetime.strptime("12/11/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("12/11/18 23:59","%d/%m/%y %H:%M"),  module=modules[4])
...
Assessment(format=AssessmentFormat.MOLE_QUIZ, name="MOLE Quiz 2", marks=0.25, release_date=datetime.strptime("14/11/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("05/12/18 23:59","%d/%m/%y %H:%M"),  module=modules[16])
Assessment(format=AssessmentFormat.MOLE_QUIZ, name="MOLE Quiz 2", marks=0.25, release_date=datetime.strptime("14/11/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("05/12/18 23:59","%d/%m/%y %H:%M"),  module=modules[12])
Assessment(format=AssessmentFormat.MOLE_QUIZ, name="Mole Quiz 2", marks=0.15, release_date=datetime.strptime("10/06/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("07/12/18 23:59","%d/%m/%y %H:%M"),  module=modules[6])
...
Assessment(format=AssessmentFormat.MOLE_QUIZ, name="MOLE Quiz 1", marks=0.2, release_date=datetime.strptime("14/11/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("14/11/18 23:59","%d/%m/%y %H:%M"),  module=modules[16])
Assessment(format=AssessmentFormat.MOLE_QUIZ, name="MOLE Quiz 1", marks=0.2, release_date=datetime.strptime("14/11/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("14/11/18 23:59","%d/%m/%y %H:%M"),  module=modules[12])
Assessment(format=AssessmentFormat.MOLE_QUIZ, name="Mole Quiz 1", marks=0.1, release_date=datetime.strptime("10/06/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("26/10/18 23:59","%d/%m/%y %H:%M"),  module=modules[6])
Assessment(format=AssessmentFormat.MOLE_QUIZ, name="MOLE Formal Examination", marks=0.5, release_date=datetime.strptime("10/06/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("01/02/19 23:59","%d/%m/%y %H:%M"),  module=modules[9])
...
Assessment(format=AssessmentFormat.MOLE_QUIZ, name="MCQ 4", marks=2, release_date=datetime.strptime("10/06/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("27/02/19 23:59","%d/%m/%y %H:%M"),  module=modules[41])
Assessment(format=AssessmentFormat.MOLE_QUIZ, name="MCQ 3", marks=2, release_date=datetime.strptime("10/06/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("20/02/19 23:59","%d/%m/%y %H:%M"),  module=modules[41])
Assessment(format=AssessmentFormat.MOLE_QUIZ, name="MCQ 2", marks=2, release_date=datetime.strptime("10/06/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("13/02/19 23:59","%d/%m/%y %H:%M"),  module=modules[41])
Assessment(format=AssessmentFormat.MOLE_QUIZ, name="MCQ 1", marks=2, release_date=datetime.strptime("10/06/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("06/02/19 23:59","%d/%m/%y %H:%M"),  module=modules[41])
...
Assessment(format=AssessmentFormat.GROUP_PROJECT, name="Semester 2 Exam", marks=0.25, release_date=datetime.strptime("10/06/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("01/06/18 23:59","%d/%m/%y %H:%M"),  module=modules[32])
Assessment(format=AssessmentFormat.GROUP_PROJECT, name="Individual Testing Report", marks=0.1, release_date=datetime.strptime("03/12/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("07/12/18 23:59","%d/%m/%y %H:%M"),  module=modules[9])
...
Assessment(format=AssessmentFormat.GROUP_PROJECT, name="Group Systems Design Project", marks=0.4, release_date=datetime.strptime("15/10/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("02/12/18 23:59","%d/%m/%y %H:%M"),  module=modules[9])
Assessment(format=AssessmentFormat.FORMAL_EXAM, name="Podcast Creation: Fundamental Security Properties and Mechanisms", marks=0.1, release_date=datetime.strptime("10/12/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("25/01/19 23:59","%d/%m/%y %H:%M"),  module=modules[21])
Assessment(format=AssessmentFormat.FORMAL_EXAM, name="n/a", marks=0.5, release_date=datetime.strptime("10/06/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("01/06/19 23:59","%d/%m/%y %H:%M"),  module=modules[35])
Assessment(format=AssessmentFormat.FORMAL_EXAM, name="formal examination", marks=0.8, release_date=datetime.strptime("10/06/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("01/02/19 23:59","%d/%m/%y %H:%M"),  module=modules[23])
Assessment(format=AssessmentFormat.FORMAL_EXAM, name="Formal Examination 1: Fundmental Security Properties and Mechanisms", marks=0.9, release_date=datetime.strptime("01/02/19 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("01/02/18 23:59","%d/%m/%y %H:%M"),  module=modules[21])
...
Assessment(format=AssessmentFormat.FORMAL_EXAM, name="Exam", marks=1, release_date=datetime.strptime("10/06/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("01/01/18 23:59","%d/%m/%y %H:%M"),  module=modules[30])
Assessment(format=AssessmentFormat.FORMAL_EXAM, name="Exam", marks=0.7, release_date=datetime.strptime("10/06/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("01/06/18 23:59","%d/%m/%y %H:%M"),  module=modules[33])
Assessment(format=AssessmentFormat.FORMAL_EXAM, name="Exam", marks=0.5, release_date=datetime.strptime("31/01/19 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("31/01/19 23:59","%d/%m/%y %H:%M"),  module=modules[8])
Assessment(format=AssessmentFormat.PROBLEM_SHEET, name="Third marked problem sheet", marks=0.075, release_date=datetime.strptime("18/03/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("25/03/18 23:59","%d/%m/%y %H:%M"),  module=modules[33])
Assessment(format=AssessmentFormat.PROBLEM_SHEET, name="Second marked problem sheet", marks=0.075, release_date=datetime.strptime("04/03/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("11/03/18 23:59","%d/%m/%y %H:%M"),  module=modules[33])
Assessment(format=AssessmentFormat.PROBLEM_SHEET, name="Lab Problem Sheet 2", marks=5, release_date=datetime.strptime("10/06/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("15/03/19 23:59","%d/%m/%y %H:%M"),  module=modules[31])
Assessment(format=AssessmentFormat.PROBLEM_SHEET, name="Lab Problem Sheet 1", marks=5, release_date=datetime.strptime("10/06/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("01/03/19 23:59","%d/%m/%y %H:%M"),  module=modules[31])
Assessment(format=AssessmentFormat.PROBLEM_SHEET, name="Fourth marked problem sheet", marks=0.075, release_date=datetime.strptime("18/03/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("29/04/18 23:59","%d/%m/%y %H:%M"),  module=modules[33])
Assessment(format=AssessmentFormat.PROBLEM_SHEET, name="First marked problem sheet", marks=0.075, release_date=datetime.strptime("18/02/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("25/02/18 23:59","%d/%m/%y %H:%M"),  module=modules[33])
...
Assessment(format=AssessmentFormat.ASSIGNMENT, name="Software Development ASSIGNMENT", marks=1, release_date=datetime.strptime("10/06/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("20/05/19 23:59","%d/%m/%y %H:%M"),  module=modules[46])
Assessment(format=AssessmentFormat.ASSIGNMENT, name="Semester 2 Review", marks=0.25, release_date=datetime.strptime("25/03/19 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("24/05/19 23:59","%d/%m/%y %H:%M"),  module=modules[49])
Assessment(format=AssessmentFormat.ASSIGNMENT, name="Semester 2 ASSIGNMENT 1: Searching Word Lattices", marks=0.125, release_date=datetime.strptime("25/02/19 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("18/03/19 23:59","%d/%m/%y %H:%M"),  module=modules[32])
Assessment(format=AssessmentFormat.ASSIGNMENT, name="Semester 1 Review", marks=0.25, release_date=datetime.strptime("03/12/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("11/01/19 23:59","%d/%m/%y %H:%M"),  module=modules[49])
Assessment(format=AssessmentFormat.ASSIGNMENT, name="report ASSIGNMENT", marks=0.2, release_date=datetime.strptime("27/09/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("26/11/18 23:59","%d/%m/%y %H:%M"),  module=modules[23])
...
Assessment(format=AssessmentFormat.ASSIGNMENT, name="Poster ASSIGNMENT", marks=0.25, release_date=datetime.strptime("29/03/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("31/05/18 23:59","%d/%m/%y %H:%M"),  module=modules[44])
Assessment(format=AssessmentFormat.ASSIGNMENT, name="PORTFOLIO assessment", marks=1, release_date=datetime.strptime("05/10/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("20/05/19 23:59","%d/%m/%y %H:%M"),  module=modules[1])
Assessment(format=AssessmentFormat.ASSIGNMENT, name="Peer Marked ASSIGNMENT", marks=0, release_date=datetime.strptime("22/10/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("29/10/18 23:59","%d/%m/%y %H:%M"),  module=modules[8])
Assessment(format=AssessmentFormat.ASSIGNMENT, name="Moderated Staff Assessment", marks=0.4, release_date=datetime.strptime("10/06/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("20/05/19 23:59","%d/%m/%y %H:%M"),  module=modules[37])
Assessment(format=AssessmentFormat.ASSIGNMENT, name="Moderated Client Assessment", marks=0.5, release_date=datetime.strptime("10/06/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("13/05/19 23:59","%d/%m/%y %H:%M"),  module=modules[37])
Assessment(format=AssessmentFormat.ASSIGNMENT, name="Main Programming Exercise", marks=0.45, release_date=datetime.strptime("23/10/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("07/12/18 23:59","%d/%m/%y %H:%M"),  module=modules[16])
Assessment(format=AssessmentFormat.ASSIGNMENT, name="Main Programming Exercise", marks=0.45, release_date=datetime.strptime("23/10/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("07/12/18 23:59","%d/%m/%y %H:%M"),  module=modules[12])
...
Assessment(format=AssessmentFormat.ASSIGNMENT, name="Individual Ruby ASSIGNMENT", marks=43617, release_date=datetime.strptime("20/11/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("14/12/18 23:59","%d/%m/%y %H:%M"),  module=modules[4])
Assessment(format=AssessmentFormat.ASSIGNMENT, name="Individual reflection", marks=0.05, release_date=datetime.strptime("10/06/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("20/05/19 23:59","%d/%m/%y %H:%M"),  module=modules[37])
...
Assessment(format=AssessmentFormat.ASSIGNMENT, name="Group Requirements Elicitation ASSIGNMENT", marks=43617, release_date=datetime.strptime("22/10/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("23/11/18 23:59","%d/%m/%y %H:%M"),  module=modules[4])
Assessment(format=AssessmentFormat.ASSIGNMENT, name="Group Report", marks=0.75, release_date=datetime.strptime("17/05/19 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("07/06/19 23:59","%d/%m/%y %H:%M"),  module=modules[44])
Assessment(format=AssessmentFormat.ASSIGNMENT, name="Forensics Research ASSIGNMENT", marks=0.5, release_date=datetime.strptime("12/12/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("25/01/19 23:59","%d/%m/%y %H:%M"),  module=modules[22])
...
Assessment(format=AssessmentFormat.ASSIGNMENT, name="Final Coursework", marks=0.6, release_date=datetime.strptime("04/12/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("14/01/19 23:59","%d/%m/%y %H:%M"),  module=modules[26])
Assessment(format=AssessmentFormat.ASSIGNMENT, name="Final ASSIGNMENT", marks=1, release_date=datetime.strptime("22/10/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("14/12/18 23:59","%d/%m/%y %H:%M"),  module=modules[20])
Assessment(format=AssessmentFormat.ASSIGNMENT, name="Final ASSIGNMENT", marks=0.7, release_date=datetime.strptime("22/11/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("07/12/18 23:59","%d/%m/%y %H:%M"),  module=modules[28])
Assessment(format=AssessmentFormat.ASSIGNMENT, name="Essay", marks=0.5, release_date=datetime.strptime("25/02/19 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("03/05/19 23:59","%d/%m/%y %H:%M"),  module=modules[49])
...
Assessment(format=AssessmentFormat.ASSIGNMENT, name="Cybersecurity and AI Dissertation Project", marks=1, release_date=datetime.strptime("29/03/19 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("11/09/19 23:59","%d/%m/%y %H:%M"),  module=modules[42])
...
Assessment(format=AssessmentFormat.ASSIGNMENT, name="ASSIGNMENT", marks=0.5, release_date=datetime.strptime("05/11/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("12/12/18 23:59","%d/%m/%y %H:%M"),  module=modules[8])
...
Assessment(format=AssessmentFormat.ASSIGNMENT, name="ASSIGNMENT part 1", marks=0.3, release_date=datetime.strptime("10/06/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("19/11/18 23:59","%d/%m/%y %H:%M"),  module=modules[11])
...
Assessment(format=AssessmentFormat.ASSIGNMENT, name="ASSIGNMENT 3: 8-off solitaire part 2", marks=0.5, release_date=datetime.strptime("26/11/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("13/12/18 23:59","%d/%m/%y %H:%M"),  module=modules[10])
...
Assessment(format=AssessmentFormat.ASSIGNMENT, name="ASSIGNMENT 2: Javascript", marks=0.25, release_date=datetime.strptime("10/06/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("10/12/18 23:59","%d/%m/%y %H:%M"),  module=modules[6])
Assessment(format=AssessmentFormat.ASSIGNMENT, name="ASSIGNMENT 2: 8-off Solitaire Part 1", marks=0.25, release_date=datetime.strptime("05/11/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("19/11/18 23:59","%d/%m/%y %H:%M"),  module=modules[10])
Assessment(format=AssessmentFormat.ASSIGNMENT, name="ASSIGNMENT 2:  Rule Networks", marks=0.125, release_date=datetime.strptime("25/03/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("30/04/18 23:59","%d/%m/%y %H:%M"),  module=modules[32])
...
Assessment(format=AssessmentFormat.ASSIGNMENT, name="ASSIGNMENT 2", marks=0.2, release_date=datetime.strptime("02/04/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("17/05/18 23:59","%d/%m/%y %H:%M"),  module=modules[52])
Assessment(format=AssessmentFormat.ASSIGNMENT, name="ASSIGNMENT 2 - MSc Project Background Report", marks=0.8, release_date=datetime.strptime("13/03/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("15/05/19 23:59","%d/%m/%y %H:%M"),  module=modules[48])
Assessment(format=AssessmentFormat.ASSIGNMENT, name="ASSIGNMENT 1: Web Site", marks=0.5, release_date=datetime.strptime("10/06/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("26/11/18 23:59","%d/%m/%y %H:%M"),  module=modules[6])
Assessment(format=AssessmentFormat.ASSIGNMENT, name="ASSIGNMENT 1: Bags", marks=0.25, release_date=datetime.strptime("08/10/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("22/10/18 23:59","%d/%m/%y %H:%M"),  module=modules[10])
...
Assessment(format=AssessmentFormat.ASSIGNMENT, name="ASSIGNMENT 1", marks=0.3, release_date=datetime.strptime("18/10/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("31/10/18 23:59","%d/%m/%y %H:%M"),  module=modules[28])
Assessment(format=AssessmentFormat.ASSIGNMENT, name="ASSIGNMENT 1", marks=0.2, release_date=datetime.strptime("26/02/19 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("29/03/18 23:59","%d/%m/%y %H:%M"),  module=modules[52])
Assessment(format=AssessmentFormat.ASSIGNMENT, name="ASSIGNMENT 1 - Peer review", marks=0.2, release_date=datetime.strptime("27/02/19 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("13/03/19 23:59","%d/%m/%y %H:%M"),  module=modules[48])
...
Assessment(format=AssessmentFormat.ASSESSED_LAB, name="Introductory Programming Exercise", marks=0.1, release_date=datetime.strptime("01/10/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("22/10/18 23:59","%d/%m/%y %H:%M"),  module=modules[12])
Assessment(format=AssessmentFormat.ASSESSED_LAB, name="Introductory Programming Exercise", marks=0.1, release_date=datetime.strptime("01/10/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("22/10/18 23:59","%d/%m/%y %H:%M"),  module=modules[16])
Assessment(format=AssessmentFormat.ASSESSED_LAB, name="Forensics Lab", marks=0.5, release_date=datetime.strptime("21/01/19 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("21/01/18 23:59","%d/%m/%y %H:%M"),  module=modules[22])
...
Assessment(format=AssessmentFormat.ASSESSED_LAB, name="Assessed Lab 2", marks=0.2, release_date=datetime.strptime("10/12/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("10/12/18 23:59","%d/%m/%y %H:%M"),  module=modules[26])
Assessment(format=AssessmentFormat.ASSESSED_LAB, name="Assessed Lab 1", marks=0.2, release_date=datetime.strptime("29/10/18 09:00","%d/%m/%y %H:%M"), submission_date=datetime.strptime("29/10/18 23:59","%d/%m/%y %H:%M"),  module=modules[26])
# add to session.
for user in users:
    db.session.add(user)
